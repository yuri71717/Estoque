...
// 2. Salvar alterações da compra e ajustar estoque (POST)
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['salvar'])) {
    ...
    // Obter quantidade anterior para calcular a diferença de estoque
...
// 3. Buscar dados da compra atual
$stmt = $pdo->prepare("
