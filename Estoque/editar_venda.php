...
// 2. Salvar alterações da venda e validar estoque (POST)
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['salvar'])) {
    ...
    // Obter quantidade anterior e estoque atual do produto
    ...
    // Verificar se há estoque suficiente caso a quantidade tenha aumentado
